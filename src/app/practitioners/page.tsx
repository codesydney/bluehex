...
/**
 * The practitioner directory. Moved off `/` to make room for Agent Exchange —
 * see #157 — with no change to what it does or how it is built, only where it
 * lives. Everything below this line, and the comments on `revalidate`, are
 * carried over from the old home page rather than rewritten.
 */
export const metadata: Metadata = {
  title: "Claude Practitioners",
  description: "Claude practitioners from the Code.Sydney community. Find one, hire one.",
};
